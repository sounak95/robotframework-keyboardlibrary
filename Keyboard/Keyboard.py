...
class Keyboard:
    ...
    """
    def __init__(self):
        print("Keyboard library initialised")

    def mx_native_type(self, key):
    ...
    def mx_press_combination(self, *keys):
        ...
        | Mx Press Combination | KEY.CTRL | KEY.C |
        | Mx Press Combination | KEY.CTRL | KEY.V | 
